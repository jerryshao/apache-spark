...
import org.apache.spark.sql.execution.streaming.sources.{RateSourceProvider, TextSocketSourceProvider}
...
object DataSource extends Logging {
  ...
  private val backwardCompatibilityMap: Map[String, String] = {
    ...
    val rate = classOf[RateSourceProvider].getCanonicalName
